-- A source file must have the same base name as the name of the module it contains.
-- The module name must begin with a capital letter.
module SimpleJSON 
-- A list of exports which is enclosed in parentheses.
